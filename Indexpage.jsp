					...
					<div class="col-md-6">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>Our Hospital is Certified by the state government for the 100% safety of patients. </p>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>Our hospital is the one of the most hygienic and disciplined hospital in the city.</p>
							</div>
						</div>
					</div>
					<div class="col-md-6 mt-2">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>The doctors are friendly and good. They are supportive anytime.</p>
							</div>
						</div>
					</div>
					<div class="col-md-6 mt-2">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>Lots of research and development has been done by our hospital.</p>
							</div>
						</div>
					</div>
				</div>
